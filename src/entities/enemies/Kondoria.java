...
public class Kondoria extends Entity {
    ...
    public Kondoria(GamePanel gp, int xUnit, int yUnit) {
        this.gp = gp;
    ...
    public void getImage() {
        try {
            left1 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_left1));
            left2 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_left2));
            left3 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_left3));
            right1 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_right1));
            right2 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_right2));
            right3 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_right3));
            dead1 = ImageIO.read(getClass().getResourceAsStream(Sprite.kondoria_dead));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void draw(Graphics2D g2) {
        ...
        if (collisionDead) {
            gp.tileManager.entities.add(new Balloon(gp, 30, 1));
            gp.tileManager.entities.add(new Oneal(gp, 1, 1));
            int score = gp.bomber.getScore() + 20;
