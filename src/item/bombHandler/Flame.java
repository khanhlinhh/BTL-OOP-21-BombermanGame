...
public class Flame extends Item {
    private BufferedImage exploded, exploded1, exploded2,
                        horizontal, horizontal1, horizontal2,
                        horizontal_left, horizontal_left1, horizontal_left2,
                        horizontal_right, horizontal_right1, horizontal_right2,
    ...
    public void getImage() {
        try {
            ...
            horizontal_left = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_horizontal_left_last));
            horizontal_left1 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_horizontal_left_last1));
            horizontal_left2 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_horizontal_left_last2));
            horizontal_right = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_horizontal_right_last));
            horizontal_right1 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_horizontal_right_last1));
            horizontal_right2 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_horizontal_right_last2));
            ...
            vertical_down = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_vertical_down_last));
            vertical_down1 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_vertical_down_last1));
            vertical_down2 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_vertical_down_last2));
            vertical_top = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_vertical_top_last));
            vertical_top1 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_vertical_top_last1));
            vertical_top2 = ImageIO.read(getClass().getResourceAsStream(Sprite.explosion_vertical_top_last2));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
